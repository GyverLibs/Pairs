...
[![arduino-library](https://www.ardu-badge.com/badge/Pairs.svg?)](https://www.ardu-badge.com/Pairs)
...
bool contains(Text key);             // проверка на существование
...
Объект пары, наследует Text для значения и содержит поле Text key для ключа.
